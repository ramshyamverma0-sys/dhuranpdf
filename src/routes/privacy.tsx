...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — Dhuran PDF" },
      { name: "description", content: "How Dhuran PDF handles your data and files." },
    ],
  }),
  component: () => (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12 prose-headings:font-bold">
      ...
      <div className="mt-6 space-y-4 text-sm text-muted-foreground leading-relaxed">
        <p><strong className="text-foreground">Your files stay on your device.</strong> The vast majority of Dhuran PDF tools run entirely in your browser. We don't upload your PDFs, images or text to our servers.</p>
        ...
        <p>By using Dhuran PDF you agree to this policy.</p>
      </div>
    </div>
  ),
});
