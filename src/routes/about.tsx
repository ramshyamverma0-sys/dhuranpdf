...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — DhuranHub" },
      { name: "description", content: "DhuranHub is a complete digital toolkit with 200+ free PDF, AI, calculator and utility tools." },
    ],
  }),
  component: About,
});
...
function About() {
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">About DhuranHub</h1>
      <p className="mt-4 text-muted-foreground">DhuranHub is a complete AI-powered digital tools ecosystem. We bring together {TOTAL_TOOLS}+ tools across {CATEGORIES.length} categories so you never have to bounce between websites again.</p>
