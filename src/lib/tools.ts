...
export const CATEGORIES: Category[] = [
  ...
  { slug: "more", name: "More Tools", description: "Extra file, security, developer, business and study tools.", icon: Sparkles, color: "from-slate-500/15 to-blue-500/15" },
...
export const TOOLS: Tool[] = [
  ...
  t("pdf-converter", "PDF Converter", "pdf", "Convert PDF to images, Word-compatible DOC or spreadsheet CSV.", FileType, "pdf-converter"),
  t("pdf-editor", "PDF Editor", "pdf", "Add text to PDF pages and download the edited file.", PenTool, "pdf-editor"),
  t("ocr-pdf", "OCR PDF", "pdf", "Recognize text from scanned PDF pages.", FileSearch, "ocr-pdf"),
  ...
  t("pdf-to-word", "PDF to Word", "pdf", "Extract PDF text into an editable Word-compatible DOC.", FileText, "pdf-to-word"),
  t("pdf-to-excel", "PDF to Excel", "pdf", "Extract PDF text and table-like rows into Excel-ready CSV.", FileSpreadsheet, "pdf-to-excel"),
  t("pdf-to-jpg", "PDF to JPG", "pdf", "Render PDF pages as JPG images.", ImageIcon, "pdf-to-jpg"),
  ...
  t("pdf-to-png", "PDF to PNG", "image-pdf", "Convert PDF pages to PNG images.", ImageIcon, "pdf-to-png"),
  t("compress-image-pdf", "Compress Image PDF", "image-pdf", "Shrink image-based PDFs.", ImageDown, "compress-pdf"),
  t("heic-to-pdf", "HEIC to PDF", "image-pdf", "Convert iPhone HEIC to PDF.", FileImage, "jpg-to-pdf"),
  t("webp-to-pdf", "WEBP to PDF", "image-pdf", "Convert WEBP images to PDF.", FileImage, "jpg-to-pdf"),
  ...
  t("ai-pdf-chat", "AI PDF Chat", "ai", "Ask questions about a PDF document.", Bot, "ai-pdf-chat"),
  ...
  t("ai-notes-generator", "AI Notes Generator", "ai", "Turn text into structured notes.", ListChecks, "ai-notes-generator"),
  t("ai-ocr-scanner", "AI OCR Scanner", "ai", "Extract text from scanned PDFs.", FileSearch, "ai-ocr-scanner"),
